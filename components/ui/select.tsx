  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon data-slot="select-icon">
        <HugeiconsIcon className="-me-1 size-4.5 opacity-80 sm:size-4" icon={UnfoldMoreIcon} strokeWidth={2} />
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          ...
          >
            <HugeiconsIcon className="relative size-4.5 sm:size-4" icon={ArrowUp01Icon} strokeWidth={2} />
          </SelectPrimitive.ScrollUpArrow>
          ...
          >
            <HugeiconsIcon className="relative size-4.5 sm:size-4" icon={ArrowDown01Icon} strokeWidth={2} />
          </SelectPrimitive.ScrollDownArrow>
        </SelectPrimitive.Popup>
      </SelectPrimitive.Positioner>
    </SelectPrimitive.Portal>
